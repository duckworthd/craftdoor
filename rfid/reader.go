...
func (r *Reader) ReadDataBlocks(timeout time.Duration, sector int) (data []byte, err error) {
...
//
// Returns a total of 16 bytes/block * 3 blocks = 48 bytes.
func (r *Reader) ReadDataBlock(timeout time.Duration, sector int, block int) (data []byte, err error) {
...
func (r *Reader) ReadAuthBlock(timeout time.Duration, sector int) (authBlock *AuthBlock, err error) {
	var auth byte = commands.PICC_AUTHENT1B
